  ...
  const printLabel = () => {
    ...
    printWindow.document.write(`
      ...
      <body>
        ...
        <div class="page">
          <!-- ส่วนข้อมูลหัวกระดาษ -->
          <div class="header" style="border: 1px solid #000;">
          ...
          <div class="tracking-number-box" style="border: 1px solid #000;">
          ...
          <!-- ข้อมูลคัดแยก -->
          <div class="info-row" style="border: 1px solid #000;">
