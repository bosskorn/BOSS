    ...
    <nav className="bg-white shadow-md py-2 px-4 sticky top-0 z-30 border-b-2 border-purple-500 purple-dash-line">
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-center">
        ...
        <ul className="flex flex-wrap justify-center md:justify-end space-x-1 md:space-x-4">
          ...
          <li className="relative">
            <div ref={ordersDropdownRef} className="dropdown">
              <button 
              ...
              {activeDropdown === 'orders' && (
                <div className="dropdown-menu absolute left-0 mt-2 w-48 bg-white rounded-md shadow-lg border border-gray-200 z-50">
                  <ul className="py-1">
                    <li>
                    ...
                    <li>
                      <Link href="/create-order" className="block px-4 py-2 text-sm text-gray-700 hover:bg-purple-50">
                        <i className="fa-solid fa-plus-circle mr-2"></i>
                        <span>สร้างออเดอร์</span>
                      </Link>
                    </li>
                    <li>
                      <Link href="/parcel-list" className="block px-4 py-2 text-sm text-gray-700 hover:bg-purple-50">
                        <i className="fa-solid fa-box-open mr-2"></i>
                        <span>รายการพัสดุ</span>
                      </Link>
                    </li>
                    <li>
                      <Link href="/claims-list" className="block px-4 py-2 text-sm text-gray-700 hover:bg-purple-50">
          ...
          <li className="relative">
            <div ref={productsDropdownRef} className="dropdown">
              <button 
              ...
              {activeDropdown === 'products' && (
                <div className="dropdown-menu absolute left-0 mt-2 w-48 bg-white rounded-md shadow-lg border border-gray-200 z-50">
                  <ul className="py-1">
                    ...
                    <li>
                      <Link href="/product-create" className={`block px-4 py-2 text-sm ${isProductCreate ? 'bg-purple-50 text-purple-600' : 'text-gray-700 hover:bg-purple-50'}`}>
                        <i className="fa-solid fa-plus-square mr-2"></i>
                        <span>สร้างสินค้า</span>
                      </Link>
                    </li>
                    <li>
                      <Link href="/category-manage" className={`block px-4 py-2 text-sm ${isCategoryManage ? 'bg-purple-50 text-purple-600' : 'text-gray-700 hover:bg-purple-50'}`}>
          ...
          <li className="relative">
            <div ref={reportsDropdownRef} className="dropdown">
              <button 
              ...
              {activeDropdown === 'reports' && (
                <div className="dropdown-menu absolute left-0 mt-2 w-48 bg-white rounded-md shadow-lg border border-gray-200 z-50">
                  <ul className="py-1">
                    ...
                    <li>
                      <Link href="/reports/by-courier" className="block px-4 py-2 text-sm text-gray-700 hover:bg-purple-50">
                        <i className="fas fa-shipping-fast mr-2"></i>
                        <span>รายงานตามขนส่ง</span>
                      </Link>
                    </li>
                    <li>
                      <Link href="/reports/by-area" className="block px-4 py-2 text-sm text-gray-700 hover:bg-purple-50">
                        <i className="fas fa-map-marked-alt mr-2"></i>
                        <span>รายงานตามพื้นที่</span>
                      </Link>
                    </li>
                    <li>
                      <Link href="/reports/cod" className="block px-4 py-2 text-sm text-gray-700 hover:bg-purple-50">
                        <i className="fas fa-dollar-sign mr-2"></i>
                        <span>รายงาน COD</span>
                      </Link>
                    </li>
                    <li>
                      <Link href="/reports/returns" className="block px-4 py-2 text-sm text-gray-700 hover:bg-purple-50">
