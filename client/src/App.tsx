...
import PrintLabelTest from "@/pages/print-label-test";
import BarcodeLabel from "@/pages/barcode-label";
...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/print-label-test" component={PrintLabelTest} />
      <Route path="/barcode-test" component={BarcodeLabel} />
