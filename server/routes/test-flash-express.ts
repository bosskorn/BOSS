...
// Endpoint สำหรับทดสอบแบบสาธารณะ ไม่ต้องการการยืนยันตัวตน
router.post('/public-test', async (req: Request, res: Response) => {
  try {
    console.log('ทดสอบการสร้างออเดอร์ Flash Express แบบสาธารณะ');
    ...
    console.log('Flash Express API Response (Public Test):', JSON.stringify(result, null, 2));
...
// Endpoint สำหรับทดสอบการสร้างออเดอร์ Flash Express โดยตรงจากข้อมูลทดสอบ (ต้องเข้าสู่ระบบ)
