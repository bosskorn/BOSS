/**
 * บริการเชื่อมต่อกับ Flash Express API - ฉบับปรับปรุงแก้ไข
 * ใช้ URL ใหม่: https://open-api-tra.flashexpress.com
 * ปรับปรุงการสร้างลายเซ็นตามเอกสารอย่างเคร่งครัด
 */
...
/**
 * สร้างการจัดส่งใหม่กับ Flash Express API (ฉบับแก้ไข)
 */
export const createFlashExpressShipping = async (
  ...
  try {
    ...
    console.log(`เริ่มสร้างการจัดส่งกับ Flash Express API สำหรับออเดอร์ ${orderData.outTradeNo} (ฉบับแก้ไข)`);
