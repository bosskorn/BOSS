...
async function testCreateShippingWithHeaders() {
  ...
  try {
    ...
    console.log('ผลลัพธ์การสร้างการจัดส่ง (ใช้ Headers พิเศษ):', JSON.stringify(result, null, 2));
...
// รันการทดสอบ
console.log('====================================================');
console.log('    การทดสอบการสร้างการจัดส่งด้วย Headers พิเศษ');
console.log('====================================================');

testCreateShippingWithHeaders()
  .then(() => {
    console.log('\n====================================================');
